...
function content_slideshow_load_translations() {
	load_plugin_textdomain( 'content-slideshow', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
add_action( 'plugins_loaded', 'content_slideshow_load_translations' );
